...
module CustomBundler
  class CLI::Info
    ...
    def spec_for_gem(name)
      CustomBundler::CLI::Common.select_spec(name, :regex_match)
    end

    def print_gem_version(spec)
      CustomBundler.ui.info spec.version.to_s
    end
    ...
    def print_gem_path(spec)
      ...
      if name == "bundler"
        ...
        if spec.deleted_gem?
          return CustomBundler.ui.warn "The gem #{name} has been deleted. It was installed at: #{path}"
        end
      end

      CustomBundler.ui.info path
    end
    ...
    def print_gem_info(spec)
      ...
      if name != "bundler" && spec.deleted_gem?
        return CustomBundler.ui.warn "The gem #{name} has been deleted. Gemspec information is still available though:\n#{gem_info}"
      end

      CustomBundler.ui.info gem_info
    end

    def gem_dependencies
      @gem_dependencies ||= CustomBundler.definition.specs.map do |spec|
