...
module CustomBundler
  class LazySpecification
    ...
    # bad gem.
    def __materialize__(candidates, fallback_to_non_installable: CustomBundler.frozen_bundle?)
    ...
    def git_version
      return unless source.is_a?(CustomBundler::Source::Git)
      " #{source.revision[0..6]}"
    end
    ...
    def ruby_platform_materializes_to_ruby_platform?
      ...
      !CustomBundler.most_specific_locked_platform?(generic_platform) || force_ruby_platform || CustomBundler.settings[:force_ruby_platform]
    end
  end
end
