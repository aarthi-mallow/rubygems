...
module CustomBundler
  # Represents metadata from when the CustomBundler gem was built.
  module BuildMetadata
    ...
    def self.git_commit_sha
      ...
      # If CustomBundler has been installed without its .git directory and without a
    ...
    # Whether this is an official release build of CustomBundler.
    def self.release?
      @release
    end
  end
