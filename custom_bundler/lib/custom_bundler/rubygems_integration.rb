...
module CustomBundler
  class RubygemsIntegration
    ...
    def validate(spec)
      CustomBundler.ui.silence { spec.validate_for_resolution }
    ...
    def replace_gem(specs, specs_by_name)
      ...
      [::Kernel.singleton_class, ::Kernel].each do |kernel_class|
        redefine_method(kernel_class, :gem) do |dep, *reqs|
          ...
          message = if spec.nil?
            target_file = begin
                            CustomBundler.default_gemfile.basename
        ...
        kernel_class.send(:public, :gem) if CustomBundler.feature_flag.setup_makes_kernel_gem_public?
      end
    end
    ...
    def replace_bin_path(specs_by_name)
      ...
      redefine_method(gem_class, :find_spec_for_exe) do |gem_name, *args|
        ...
        unless spec || !matching_specs_by_exec_name.empty?
          ...
          if spec_with_name.nil?
            message += ". #{gem_name} is not currently included in the bundle, " \
                       "perhaps you meant to add it to your #{CustomBundler.default_gemfile.basename}?"
          end
        ...
        unless spec
          ...
          warn \
            "CustomBundler is using a binstub that was created for a different gem (#{spec.name}).\n" \
    ...
    def add_default_gems_to(specs)
      ...
      CustomBundler.rubygems.default_stubs.each do |stub|
    ...
    def fetch_specs(remote, name, fetcher)
      ...
      specs = CustomBundler.safe_load_marshal(string)
    ...
    def download_gem(spec, uri, cache_dir, fetcher)
      require "rubygems/remote_fetcher"
      uri = CustomBundler.settings.mirror_for(uri)
      CustomBundler::Retry.new("download gem from #{uri}").attempts do
      ...
      raise CustomBundler::HTTPError, "Could not download gem from #{uri} due to underlying error <#{e.message}>"
    end
    ...
    def all_specs
      SharedHelpers.major_deprecation 2, "CustomBundler.rubygems.all_specs has been removed in favor of CustomBundler.rubygems.installed_specs"
