...
class CustomBundler::Thor
  module Shell
    class Basic
      ...
      # Called if something goes wrong during the execution. This is used by CustomBundler::Thor
      # internally and should not be used inside your scripts. If something went
      # wrong, you can always raise an exception. If you raise a CustomBundler::Thor::Error, it
      ...
      # CustomBundler::Thor::Shell::Basic class.
      #
    ...
    protected
      ...
      def ask_simply(statement, color, options)
        ...
        result = CustomBundler::Thor::LineEditor.readline(message, options)
