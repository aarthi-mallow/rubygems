...
class CustomBundler::Thor
  ...
  class << self
    ...
    # Registers another CustomBundler::Thor subclass as a command.
    #
    # ==== Parameters
    # klass<Class>:: CustomBundler::Thor subclass to register
    # command<String>:: Subcommand name to use
    # usage<String>:: Short usage for the subcommand
    # description<String>:: Description for the subcommand
    def register(klass, subcommand_name, usage, description, options = {})
      if klass <= CustomBundler::Thor::Group
    ...
    #
    # ==== Parameters
    # shell<CustomBundler::Thor::Shell>
    # command_name<String>
    #
    ...
    def help(shell, subcommand = false)
      ...
      CustomBundler::Thor::Util.thor_classes_in(self).each do |klass|
    ...
    def subcommand(subcommand, subcommand_class)
      ...
      define_method(subcommand) do |*args|
        args, opts = CustomBundler::Thor::Arguments.split(args)
    ...
    # which should be handled by CustomBundler::Thor.
    #
  ...
  protected
    ...
    # thor class by another ways which is not the CustomBundler::Thor::Runner. It receives
    ...
    def dynamic_command_class #:nodoc:
      CustomBundler::Thor::DynamicCommand
    end
    ...
    def create_command(meth) #:nodoc:
      ...
      if @usage && @desc
        base_class = @hide ? CustomBundler::Thor::HiddenCommand : CustomBundler::Thor::Command
