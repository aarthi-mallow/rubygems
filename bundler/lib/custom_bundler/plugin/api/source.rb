    ...
    class API
      ...
      module Source
        ...
        def post_install(spec, disable_exts = false)
          ...
          installer = CustomBundler::Source::Path::Installer.new(spec, opts)
        ...
        #
        # @return [CustomBundler::Index] index containing the specs
        def specs
          files = fetch_gemspec_files

          CustomBundler::Index.build do |index|
            files.each do |file|
              next unless spec = CustomBundler.load_gemspec(file)
