...
module CustomBundler
  class GemHelper
    ...
    def initialize(base = nil, name = nil)
      ...
      @gemspec = CustomBundler.load_gemspec(@spec_path)
      @tag_prefix = ""
    end
    ...
    def build_gem
      ...
      sh([*gem_command, "build", "-V", spec_path]) do
        ...
        CustomBundler.ui.confirm "#{name} #{version} built to pkg/#{file_name}."
      end
    ...
    def install_gem(built_gem_path = nil, local = false)
      ...
      cmd << "--local" if local
      sh(cmd)
      CustomBundler.ui.confirm "#{name} (#{version}) installed."
    end
    ...
    def build_checksum(built_gem_path = nil)
      ...
      CustomBundler.ui.confirm "#{name} #{version} checksum written to checksums/#{file_name}."
    end
    ...
    def rubygem_push(path)
      ...
      sh_with_input(cmd)
      CustomBundler.ui.confirm "Pushed #{name} #{version} to #{gem_push_host}"
    end
    ...
    def git_push(remote = nil)
      ...
      CustomBundler.ui.confirm "Pushed git commits and release tag."
    end
    ...
    def already_tagged?
      ...
      CustomBundler.ui.confirm "Tag #{version_tag} has already been created."
      true
    end
    ...
    def tag_version
      ...
      CustomBundler.ui.confirm "Tagged #{version_tag}."
      yield if block_given?
    rescue RuntimeError
      CustomBundler.ui.error "Untagging #{version_tag} due to error."
    ...
    def gem_key
      CustomBundler.settings["gem.push_key"].to_s.downcase if CustomBundler.settings["gem.push_key"]
    end
