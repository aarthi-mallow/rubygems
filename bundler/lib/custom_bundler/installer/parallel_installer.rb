...
module CustomBundler
  class ParallelInstaller
    ...
    def worker_pool
      @worker_pool ||= CustomBundler::Worker.new @size, "Parallel Installer", lambda {|spec_install, worker_num|
    ...
    def do_install(spec_install, worker_num)
      ...
      gem_installer = CustomBundler::GemInstaller.new(
    ...
    def handle_error
      ...
      if exception = errors.find {|e| e.is_a?(CustomBundler::BundlerError) }
        raise exception
      end
      raise CustomBundler::InstallError, errors.join("\n\n")
    end
