...
module CustomBundler
  class SpecSet
    ...
    def add_extra_platforms!(platforms)
      ...
      less_specific_platform = new_platforms.find {|platform| platform != Gem::Platform::RUBY && CustomBundler.local_platform === platform && platform === CustomBundler.local_platform }
      platforms.delete(CustomBundler.local_platform) if less_specific_platform
