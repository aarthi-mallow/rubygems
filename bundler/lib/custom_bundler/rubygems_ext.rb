...
# CustomBundler monkeypatches are loaded before RubyGems activates an executable (for
...
# Cherry-pick fixes to `Gem.ruby_version` to be useful for modern CustomBundler
...
module Gem
  ...
  class Specification
    ...
    include ::CustomBundler::MatchMetadata
    include ::CustomBundler::MatchPlatform
    ...
    def git_version
      return unless loaded_from && source.is_a?(CustomBundler::Source::Git)
      " #{source.revision[0..6]}"
    end
  ...
  module BetterPermissionError
    def data
      ...
      raise CustomBundler::PermissionError.new(loaded_from, :read)
    end
  end
  ...
  class Dependency
    ...
    include ::CustomBundler::ForcePlatform
