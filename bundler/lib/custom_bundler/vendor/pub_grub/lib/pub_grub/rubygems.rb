module CustomBundler::PubGrub
  module RubyGems
    ...
    def requirement_to_constraint(package, requirement)
      CustomBundler::PubGrub::VersionConstraint.new(package, range: requirement_to_range(requirement))
    end
    ...
    def parse_constraint(package, dep)
      ...
      CustomBundler::PubGrub::VersionConstraint.new(package, range: range)
    end
  end
end
