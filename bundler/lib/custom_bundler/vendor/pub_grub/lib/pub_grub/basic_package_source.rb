...
module CustomBundler::PubGrub
  # Types:
  #
  # Where possible, CustomBundler::PubGrub will accept user-defined types, so long as they quack.
  #
  # ## "Package":
  #
  ...
  # parse_dependency to convert it to a format CustomBundler::PubGrub understands.
  #
  ...
  class BasicPackageSource
    ...
    # Override me!
    #
    # Convert a (user-defined) dependency into a format CustomBundler::PubGrub understands.
    #
    # Package is passed to this method but for many implementations is not
    # needed.
    #
    # Returns: either a CustomBundler::PubGrub::VersionRange, CustomBundler::PubGrub::VersionUnion, or a
    #   CustomBundler::PubGrub::VersionConstraint
    ...
    def incompatibilities_for(package, version)
      ...
      package_deps[version].map do |dep_package, dep_constraint_name|
        ...
        if !dep_constraint
          ...
          cause = CustomBundler::PubGrub::Incompatibility::InvalidDependency.new(dep_package, dep_constraint_name)
