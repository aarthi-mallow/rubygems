...
class CustomBundler::Thor
  module Actions
    ...
    module ClassMethods
      # Hold source paths for one CustomBundler::Thor instance. source_paths_for_search is the
    ...
    def run_ruby_script(command, config = {})
      return unless behavior == :invoke
      run command, config.merge(with: CustomBundler::Thor::Util.ruby_command)
    end
    ...
    #                Other options are given as parameter to CustomBundler::Thor.
    #
    #
    # ==== Examples
    #
    ...
    def thor(command, *args)
      ...
      args.push CustomBundler::Thor::Options.to_switches(config)
