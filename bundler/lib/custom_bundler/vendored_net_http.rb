...
#
# CustomBundler specs load this code from `spec/support/vendored_net_http.rb` to avoid
# activating the CustomBundler gem too early. Without this guard, we get redefinition
# warnings once CustomBundler is actually activated and
