...
require_relative "custom_bundler/vendored_fileutils"
require "pathname"
require "rbconfig"

require_relative "custom_bundler/errors"
require_relative "custom_bundler/environment_preserver"
require_relative "custom_bundler/plugin"
require_relative "custom_bundler/rubygems_ext"
require_relative "custom_bundler/rubygems_integration"
require_relative "custom_bundler/version"
require_relative "custom_bundler/constants"
require_relative "custom_bundler/current_ruby"
require_relative "custom_bundler/build_metadata"
...
module Bundler
  ...
  class << self
    ...
    # Returns an instance of CustomBundler::Definition for given Gemfile and lockfile
    #
    ...
    def clean_env
      ...
      removed_message =
        ...
        "If you instead want the environment before bundler was originally loaded, use `Bundler.original_env`"
      CustomBundler::SharedHelpers.major_deprecation(2, message, removed_message: removed_message, print_caller_location: true)
      unbundled_env
    end
    ...
    def self_manager
      @self_manager ||= begin
                          require_relative "custom_bundler/self_manager"
                          CustomBundler::SelfManager.new
                        end
    end
    ...
    def configure_gem_path
      unless use_system_gems?
        ...
        CustomBundler::SharedHelpers.set_env "GEM_PATH", ""
      end
    end

    def configure_gem_home(path)
      CustomBundler::SharedHelpers.set_env "GEM_HOME", path.to_s
    end
